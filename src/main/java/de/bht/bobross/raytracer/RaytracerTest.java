...
public class RaytracerTest {
  ...
  public static void pointLightPhongDisc(){
    ...
    final Plane plane =  new Plane( new Point3(0, 0, 0), new Normal3(0, 1, 0), new PhongMaterial(RED, WHITE, 64));
    final Sphere sphere = new Sphere( new Point3(1, 1, 1), 0.5, new PhongMaterial(GREEN, WHITE, 64) );
    final Disc disc = new Disc( new Point3(0,2,-1), new Normal3( 0, 0, 1 ), 0.5, new LambertMaterial( GREEN ) );

    final Camera c = new PerspectiveCamera( CAM_POSITION, new Vector3(-1,-1,-1), new Vector3(0,1,0), Math.PI/4);
    final World w = new World( new Geometry[] {aab, plane, sphere, disc}, new Light[] { POINTLIGHT }, BLACK, BLACK);
  ...
  public static void spotLightPhongAmbient () {
    ...
    final Camera c = new PerspectiveCamera( CAM_POSITION, new Vector3(-1,-1,-1), new Vector3(0,1,0), Math.PI/4);
    final World w = new World( new Geometry[] {aab, plane, sphere, triangle}, new Light[] { SPOTLIGHT }, BLACK, new Color(.25, .25, .25));
